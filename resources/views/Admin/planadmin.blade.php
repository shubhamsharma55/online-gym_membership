            ...
            <main class="h-full overflow-y-auto">
                <div class="container px-6 mx-auto grid">
                    <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
                        Add New Plan To 'OUR' Customer
                    </h2>
                    <div class="alert alert-success" role="alert" id="massage" hidden>
                        Plan Insert Successfully.......!!
                    </div>
                    <form action="{{url('/admin/plan/create')}}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-2">
                                <!-- <label for="plan" class="mb-3 ">Plan Name</label> -->
                            </div>
                            <div class="col-8">
                                <input type="text" name="plan" id="planname" placeholder="Plan Name" class="w-100 form-control">
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                <input type="number" name="price" placeholder="Price For Plan" id="price" class="my-1 w-100 form-control">
                                <span style="color:red">&nbsp;</span>
                            </div>
                        </div>
                        <div class="text-center">
                            <button class=" w-30 btn btn-primary  " id="submit" type="submit">Add New Plan</button>
                        </div>
                    </form>
                </div>
            </main>
